...
exports.allExcluded = exports.noneIncluded = exports.unsupported = exports.unloaded = void 0;
function formatAvailable(available) {
    return available.sort().join(', ');
}
function unloaded(unavailable, available) {
    return new Error(`The following universes were not selected when Nerdata was initialized: ${unavailable
        .sort()
