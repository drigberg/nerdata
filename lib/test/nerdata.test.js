        ...
        describe('limit by inclusion', () => {
            ...
            describe('negative', () => {
                it('empty array', () => {
                    ...
                    chai_1.expect(error.message).to.equal('opts.include must have at least one item, if specified. Options are: dune, lord-of-the-rings, rick-and-morty, star-wars');
                });
                it('invalid universe', () => {
                    let error;
                    try {
                    ...
                    chai_1.expect(error.message).to.equal('The following universes are unsupported or misspelled: duun, twilight. Available universes are: dune, lord-of-the-rings, rick-and-morty, star-wars');
                });
            });
        });
        describe('limit by exclusion', () => {
            describe('positive', () => {
                ...
                it('array - two items', () => {
                    ...
                    chai_1.expect(nerdata._universes()).have.same.members(['lord-of-the-rings', 'star-wars']);
                });
            });
        });
        describe('negative', () => {
            it('array - all items', () => {
                let error;
                try {
                    new Nerdata_1.Nerdata({ exclude: ['dune', 'lord-of-the-rings', 'rick-and-morty', 'star-wars'] });
                }
                catch (err) {
                    error = err;
                }
